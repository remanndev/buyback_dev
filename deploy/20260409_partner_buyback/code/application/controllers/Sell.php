...
class Sell extends CI_Controller {
    ...
    public function pickup()
    {
        ...
        $data = array(
            ...
            'default_name' => $this->_get_default_applicant_name(),
            'default_phone' => $this->_get_default_applicant_phone(),
    ...
    private function _get_current_userinfo()
    {
    ...
    private function _get_default_applicant_name()
    {
        $user = $this->_get_current_userinfo();
        if (!$user) {
            return '';
        }
    ...
    private function _get_default_applicant_phone()
    {
        $user = $this->_get_current_userinfo();
