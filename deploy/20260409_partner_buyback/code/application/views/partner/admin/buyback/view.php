    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8 flex items-center justify-between gap-4">
            <div>
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo html_escape($partner['name']); ?> 요청 상세</h1>
            </div>
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <section class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4">정산 정보</h2>
                <div class="space-y-3 text-sm">
                    ...
                    <div><span class="font-medium text-gray-500">접수번호</span><div class="mt-1 text-gray-900 dark:text-white"><?php echo html_escape(isset($request['request_no']) ? $request['request_no'] : ''); ?></div></div>
                </div>
            </section>
        </div>
