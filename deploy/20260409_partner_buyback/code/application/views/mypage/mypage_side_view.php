...
?>
			...
			<div class="mypage_side d-none d-md-block" style="width:91%; ">
				...
				<?php
					// 서브메뉴 active 설정
					$arr_active = array(
						'snav0'=> ((isset($this->arr_seg[2]) && 'buyback' == $this->arr_seg[2]) ? 'true' : 'false'),
				...
				<div id="lnb" class="my_lnb" role="menu">
					...
					?>
					<a href="/mypage/buyback/lists" role="menuitem" class="my_lnb_item" id="lnb_my_buyback" aria-current="<?php echo $arr_active['snav0']; ?>">매입 신청 내역</a>
