                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-400 mt-1">
                                            <?php echo html_escape(trim((isset($item['postcode']) ? $item['postcode'] . ' ' : '') . $item['address1'] . ' ' . $item['address2'])); ?>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900 dark:text-white">
                                        <?php echo html_escape($format_admin_buyback_price(isset($item['total_price_text']) ? $item['total_price_text'] : '', isset($item['total_price_value']) ? $item['total_price_value'] : null)); ?>
