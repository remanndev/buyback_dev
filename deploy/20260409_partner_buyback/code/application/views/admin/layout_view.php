...
<html lang="ko">
  ...
  <body>
	...
	<?php
		// 헤더
		$this->load->view('admin/layout_header_main_view');
	?>
	</header>
	...
	<div class="page-container">
		...
		<?php
			...
			if (in_array($seg2, array('user', 'partner', 'npo'), true)) {
				$snb_view = 'admin/layout_snb_member_main_view';
			} elseif ($seg2 === 'buyback') {
				$snb_view = 'admin/layout_snb_buyback_view';
			} else {
