<div class=" admin_wrap">
	...
	<div class="tbl_frm">
		...
		<tr>
		  ...
		  <th>TYPE</th>
		  <td>
			<select name="admin_type" class="o_selectbox">
				<option value="SITE" <?php echo ((isset($row->type) ? $row->type : 'SITE') == 'SITE') ? 'selected' : ''; ?>>SITE</option>
				<option value="BOTH" <?php echo ((isset($row->type) ? $row->type : 'SITE') == 'BOTH') ? 'selected' : ''; ?>>BOTH</option>
			</select>
		  </td>
		</tr>
		<tr>
		  <th>가입 일자</th>
		  <td colspan="3"><?php echo (isset($row->created) ? $row->created : ''); ?></td>
		</tr>
		<tr>
