<?php
	...
	// 캠페인 인 경우
	if(isset($cmp->title) && $cmp->title != '' ) {
		$og_title = $cmp->title .' - '. $this->config->item('website_name', 'tank_auth');
		$og_description = cut_str(remove_tags($cmp->content),100);
		$og_image = $cmp->campaign_main_src;
	}
?><!doctype html>
<html class="no-js" lang="ko" dir="ltr">
  <head>
	...
	<meta name="viewport" content="width=980, initial-scale=0.4, maximum-scale=1.0, user-scalable=no">
	...
	<!-- Naver -->
	<meta name="naver-site-verification" content="4ccd6ff112598448284ad065ee92a9a6b12d730b" />
	<meta name="naver-site-verification" content="c3f1e672639872d5156faf6cb7d0a780cfa743f6" /><!-- 2025-03-19 -->
	...
	<!-- [if IE]><![endif] -->
	<link rel="stylesheet" href="<?php echo CSS_DIR ?>/ie.css?v=<?php echo rand() ?>" />
	...
	<!-- scrollreveal-master -->
	<script src="<?php echo LIB_DIR ?>/scrollreveal-master/dist/scrollreveal.min.js"></script>

	<!-- Scripts -->
	<script src="<?php echo JS_DIR ?>/common.js?v=<?php echo rand() ?>"></script>
	<script src="<?php echo JS_DIR ?>/layout.js?v=<?php echo rand() ?>"></script>
	<script src="<?php echo JS_DIR ?>/layout_replus.js?v=<?php echo rand() ?>"></script>
	...
	<?php /* replus3000@gmail.com ## remann7297!! */ ?>
	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-RD8Q5YL86L"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'G-RD8Q5YL86L');
	</script>
