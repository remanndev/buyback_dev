		...
		<div class="login-shell">
			...
			<section class="login-hero">
				<div>
					...
					<h1 class="hero-title">로그인 후<br>매입 서비스를 이어가세요</h1>
					<p class="hero-desc">
						신청 내역 확인, 매입 진행 상태 조회, 수거 일정 관리까지
						한 번의 로그인으로 편리하게 이용하실 수 있습니다.
					</p>
					...
					<div class="hero-points">
						...
						<div class="hero-point">
							...
							<div>
								...
								<span>이메일 로그인과 인증코드 절차로 보다 안전하게 보호됩니다.</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div style="font-size:13px; color:rgba(255,255,255,0.78); line-height:1.7;">
					문의가 필요하시면 고객센터를 통해 빠르게 안내해드립니다.
				</div>
			</section>
			...
			<section class="login-card">
				...
				<div class="auth-line" style="<?php echo $hide_by_admin ?>">
					<span class="auth_line_text">또는</span>
				</div>
				...
				>
								...
								<?php } else { ?>
									<div class="form-group">
										...
										<div class="captcha-box">
											...
											<div id="btn_renew_code" class="captcha-image-wrap" title="클릭하시면 새로운 코드로 갱신됩니다.">
					...
					<div class="login-note">
						로그인에 문제가 있으신 경우, 입력하신 이메일/아이디와 비밀번호를 다시 확인해 주세요.
					</div>
				</div>
			</section>
		</div>
...
$(document).ready(function(){
	...
	$('#btn_renew_code').on('click', function(){
		// 기존 캡차 갱신 스크립트가 따로 있으면 그대로 연결
		// 예: location.reload(); 또는 ajax renew 함수 호출
	});
});
</script>