	...
	<div class="ctnt_inside">
		...
		<div id="cmpfrm">
			...
			<?php echo form_open_multipart($this->uri->uri_string(), array('id'=>'donation_form','name'=>'donation_form', 'onsubmit'=>'return form_check();')); ?>
				...
				<dl class="frm_0 mt-5 dsp_flex">
					...
					<dd class="pt-2">
						...
						<ul class="" style="padding-left: 1rem; list-style-type: '- '; font-size:.9rem; margin: 0;">
							...
							<li>태블릿PC</li>
							<li>스마트폰</li>
							<li>저장장치 (HDD/SSD/외장하드 등)</li>
							<li>데스크탑 (별도 포장 필요)</li>
						</ul>

						<div style="margin-top: 10px; font-size:.9rem; ">
							* 박스 수령 후 내부에 들어있는 안내 설명을 참고해 기부물품 수거 신청을 별도로 진행해주셔야 합니다.<br />
							* 데스크탑은 별도의 박스에 직접 포장해주셔야 하며, 리플러스박스와 함께 놔주세요.  
						</div>

						<!-- <div style="font-size:.9rem; ">※ 데스크톱은 별도의 박스에 포장하여 기부 가능 </div>
						<div style="margin-top: 10px; font-size: .96rem; ">* 박스 수령 후 내부에 들어있는 안내 설명을 참고해 기부물품 수거 신청을 별도로 진행해주셔야 합니다.</div> -->
					...
					<dd>
						<div class="frm_dd_box roundbox_5 class_shadow_rb">
							<div class="mb-3">
								...
								<div id="error_donor_goods" class="error_donor">기부 물품 정보는 필수입니다.</div>
							...
							<div class="mt-3" style="font-size:1rem; line-height: 150%; ">
								...
								<ul class="" style="padding-left: .5rem; list-style-type: '• '; font-size:.9rem;">
									...
									<li>재생이 안되는 기기는 적법한 방법으로 폐기하여, 폐기된 금액으로 부품을 구매하여 재생합니다.</li>
									<li style="margin-top: 10px;">상태 설명 안내
								...
								<div style="margin-top: 10px;">
								  <div style=" font-size:1.1rem; font-weight: 600;">주의사항</div>
								  <div style="margin-top:3px; margin-left: 10px; font-size: 0.9rem;">
									- 물품이 크기로 인해 리플러스박스안에 들어가지 않는 경우 별도의 박스에 포장하여 리플러스박스와 함께 놔주세요.<br />
									- 원활한 수거를 위해 해당 박스 위에 <리플러스>라고 메모를 남겨주세요. <br />
								  </div>
								</div>
							</div>
						</div>
				...
				<!-- <dl class="frm_0 mt-5 dsp_flex"  style="display: none;">
					<dt>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.btn_add_goods_div').on('click',function() {
			...
			var ino = $("#donation_form input[name='goods_kind[]']").length;
			console.log( ino );

			if( ino > 9 ) {
				alert('최대 10개까지 등록하실 수 있습니다.');
			}
			else {
