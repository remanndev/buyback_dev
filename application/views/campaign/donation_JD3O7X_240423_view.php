  ...
  <div class="ctnt_wrap">
	<div class="ctnt_inside">
		...
		<div id="cmpfrm">
			...
			<!-- 캠페인 명 -->
			<div class="my-5 p-2" style="text-align:center; font-size:24px;">
			...
			<?php echo form_open_multipart($this->uri->uri_string(), array('id'=>'donation_form','name'=>'donation_form', 'onsubmit'=>'return form_check();')); ?>
				...
				<dl class="frm_0 mt-5 dsp_flex">
					...
					<dd class="pt-2">
						<ul class="" style="padding-left: 1rem; list-style-type: '- '; font-size:.9rem;">
							<li>사용 가치가 있는 디지털기기만을 기부해주세요.</li>
							<li>노트북,테스크톱,태블릿,모니터,스마트폰</li>
							<li>저장장치는 가능하면 포맷 또는 초기화해서 보내주시고, 직접 하기 어려운 경우 데이터 삭제 요청을 해주세요.</li>
							<li>5개 이하의 소량 기부는 박스 포장을 해 주셔야 합니다. 포장크기는 우체국 5호 박스 정도입니다.</li>
						</ul>
						<!-- <div class="mt-3"><small>※ 불법적으로 활용한 물품일 경우 기부하실 수 없습니다.</small></div> -->
					</dd>
				</dl>
				...
				<dl class="frm_0 mt-5 dsp_flex">
					...
					<dd>
						...
						<div class="frm_dd_box roundbox_5 class_shadow_rb">
							<div class="frm_subttl">기부신청자 정보</div>
							<div class="mt-4 mb-3">
								<label class="o_radio4 btn_donor_type" for="donor_type_B" data-type="B"><strong>법인</strong> 상호/법인명의로 신청합니다. 
								  <input type="radio" name="donor_type" id="donor_type_B" value="B" >
								  <span class="checkmark"></span>
								</label>
								<label class="o_radio4 btn_donor_type" for="donor_type_A" data-type="A"><strong>개인</strong> 개인 명의로 신청합니다. 
								  <input type="radio" name="donor_type" id="donor_type_A" value="A">
								  <span class="checkmark"></span>
								</label>
								<div id="error_donor_donor_type" class="error_donor">기부 신청자 정보(개인/사업자)를 선택해주세요.</div>
							</div>
						</div>
								...
								<div class="frm_tbl">
									...
									<table style="width:100%;">
										...
										<tr class="type_B" style="display: none;">
											<th>상호/법인명</th>
											<td>
												<input type="text" id="name_org" class="o_input" style="width: 100%;" name="name_org" value="<?php echo isset($user->comp_name) ? $user->comp_name : ''; ?>"  autocomplete='off'> 
												<div><small style="font-size: 15px; letter-spacing:-2px;">대표자 명이 아닌 사업자 등록증 상에 등록된 상호/법인명을 입력해주세요.</small></div>
												<div id="error_donor_name_org" class="error_donor">상호/법인명 입력은 필수입니다.</div>
											</td>
										</tr>
										<tr class="type_B" style="display: none;">
											<th>담당자 부서</th>
											<td>
												<input type="text" id="manager_dept" class="o_input" style="width: 100%;" name="manager_dept" value=""  autocomplete='off'> 
											</td>
										</tr>
										<tr class="type_B" style="display: none;">
											<th>담당자 직함</th>
											<td>
												<input type="text" id="manager_title" class="o_input" style="width: 100%;" name="manager_title" value=""  autocomplete='off'> 
											</td>
										</tr>
										...
										<!-- <tr>
											...
											<td>
												...
												<div class="pt_5">
													<input type="text" id="addr_detail" class="o_input" style="width:100%;" name="addr_detail" value="<?php echo (isset($user->addr_detail) ? $user->addr_detail : ''); ?>" placeholder="추가주소를 입력해주세요. 만약 추가 주소가 없을 경우 <주소끝>이라고 메모해주세요." autocomplete='off' />
												</div>
												<div id="error_donor_addr" class="error_donor">주소 입력은 필수입니다.</div>
												<div id="error_donor_addr2" class="error_donor">추가주소가 없을 경우 <주소끝>이라고 메모해주세요.</div>
											</td>
										</tr>
										<tr>
											<th>이메일</th>
						...
						<div class="frm_dd_box roundbox_5 class_shadow_rb">
							<div class="mb-3">
								...
								<div style="position: absolute; top: 0; right: 0; z-index: 100;">
								  <button type="button" class="o_btn btn btn-success-flat   btn_add_goods_div d-block ">등록</button>
								</div>
							...
							<script type="text/javascript">
								...
								function readImage(input, no) {
									...
									if(input.files && input.files[0]) {
										...
										if( imageFileSize > 4096000 ) { // 4MB = 4096000
											upload_call = false;
											attach_file.val('');
											alert('사진의 크기(4MB 초과)가 너무 큽니다.\n4MB 이하의 사진을 업로드해주세요.');
										}
							...
							<div class="mt-3" style="font-size:1rem; line-height: 150%; ">
								...
								<ul class="" style="padding-left: .5rem; list-style-type: '• '; font-size:.9rem; font-family: 'Nanum Gothic','Noto Sans KR', AppleSDGothicNeo-Regular,'맑은 고딕','Malgun Gothic',dotum,'돋움',sans-serif;">
				...
				<dl class="frm_0 mt-5 dsp_flex">
					...
					<dd>
						<div class="frm_dd_box roundbox_5 class_shadow_rb">
							<div class="frm_subttl">행사 당일 물품 수거</div>
							<div class="mt-4 mb-3">

								<div style="display: inline-block;">
									<input type="text" id="pickup_date_plz" class="o_input" name="pickup_date_plz" value="2024-04-23" readOnly placeholder="방문 희망일을 입력해주세요." style="width: 100%; max-width: 360px; height: 46px; font-size:17px; background-color: #ebf7e7;"  autocomplete='off' />
								</div>
								<div id="error_goods_pickup_date_plz" class="error_donor">물품 수거를 위한 방문 희망일자를 입력해주세요.</div>
								<?php /*><!-- <div class="mt-2"><small style="font-size: .9rem;">※ 물품이 소규모이거나 수도권 외곽 지역일 경우 방문 희망일 보다 다소 늦어질 수 있습니다.</small></div>
								<div class="type_A_only" style="display: none;"><small style="font-size: .9rem;">※ CJ대한통운에서 수거되며 택배는 "반품"으로 예약됩니다.</small></div> --><?php */ ?>
							</div>
						</div>
					</dd>
				</dl>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		// 개인 / 사업자 구분
		$('.btn_donor_type').on('click', function() {
...
<script type="text/javascript">
	function form_check() {
			...
			var donor_type = $("input:radio[name='donor_type']").is(":checked");
			var donor_type_val = $("input:radio[name='donor_type']:checked").val();
			...
			if(! donor_type || '' == donor_type_val) { 
				$('#error_donor_donor_type').show();
				alert('기부 신청자 정보(개인/사업자)를 선택해주세요.');
				return false;
			}
			else {
				$('#error_donor_donor_type').hide();
			}

			if('B' == donor_type_val && '' == name_org) {
				$('#error_donor_name_org').show();
				alert('상호/법인명을 입력해주세요.');
				return false;
			}
			else {
				$('#error_donor_name_org').hide();
			}


			if('A' == donor_type_val && '' == name) {
				$('#error_donor_name').show();
				alert('이름을 입력해주세요.');
				return false;
			}
			else if('B' == donor_type_val && '' == name) {
				$('#error_donor_name').show();
				alert('담당자명을 입력해주세요.');
				return false;
			}
	...
	<script type="text/javascript">
		...
		$('.datepicker').datetimepicker({
		  ...
		  beforeShowDay: function(date) {
			...
			// true=선택가능 / false=불가
			return [!(isWeekend || inBlockedRange || isBlockedDate)];
		  }
		});
