  ...
  <div class="ctnt_wrap py_35">
	<div class="ctnt_inside">
					...
					<?php echo form_open_multipart($this->uri->uri_string(), array('id'=>'board_form','name'=>'board_form','onsubmit'=>'frm_submit();')); ?>
						...
						<h3 class="mt-5 pt-5 pb-3">수혜자 정보 <small style="color:#000; font-size:15px;">( <input type="checkbox" id="same_form" /> <label for="same_form" style="color:#000; font-size:15px;">신청자 정보와 동일합니다.)</label></small></h3>
						<div class="tbl_purple tbl_share_sky" style="">
							<table style="width:100%; ">
								...
								<!-- <tr>
									<th>생년월일 <span class="color_red">*</span></th>
									<td>
										<input type="text" id="bnf_birthday" class="o_input" name="bnf_birthday" value="<?php echo set_value('bnf_birthday'); ?>" >
										<div><small style="color:#7a7a7a;">예) 770717 (1977년 7월 17일)</small></div>
								...
								<tr>
									...
									<td><div class="ttl_mobile"><h5>수혜대상 소개 및 기기 활용목적<span class="color_red">*</span></h5></div>
