				...
				<dl class="frm_0 mt-5 dsp_flex">
					...
					<dd class="pt-2">
						...
						<div style="margin-top: 10px; font-size:.9rem; ">
							...
							* 박스 수령 후 내부에 들어있는 안내 설명을 참고하여 포장해주세요. <br />
							* 포장을 완료한 뒤 마이페이지에서 수거 신청 버튼을 눌러주시면 회수가 진행됩니다.  <br />
				...
				<dl class="frm_0 mt-5 dsp_flex">
					...
					<dd>
						<div class="frm_dd_box roundbox_5 class_shadow_rb">
							 ...
							 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
							  ?>
							<div class="mb-2 dsp_flex">
								<label for="chk_agree_cpoint" class="o_checkbox4"><strong>[선택]</strong> 탄소중립포인트제 연동에 동의합니다. 
									<input type="checkbox" name="chk_agree_cpoint" id="chk_agree_cpoint" />
									<span class="checkmark"></span>
								</label>
								<small class="ms-2" style="display: inline-block;"><a href="https://www.cpoint.or.kr/netzero/main.do" target="_blank" style="text-decoration:underline; color:#55a635; ">가입확인</a></small>
								<small class="ms-2" style="display: inline-block;"><a href="/page/term_cpoint" target="_blank" style="text-decoration:underline; color:#55a635; ">내용보기</a></small>
							</div>
							<?php  */ ?>
