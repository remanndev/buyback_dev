		...
		<div id="cmpfrm">
			...
			<?php echo form_open_multipart($this->uri->uri_string(), array('id'=>'donation_form','name'=>'donation_form', 'onsubmit'=>'return form_check();')); ?>
				...
				*/ ?>
							...
							<div class="mt-4 mb-3">
								...
								*/ ?>
								<label class="o_radio4 btn_donor_type" for="donor_type_A" data-type="A"><strong>개인</strong> 개인 명의로 신청합니다. 
								  <input type="radio" name="donor_type" id="donor_type_A" value="A" checked>
								  <span class="checkmark"></span>
								</label>
				...
				<dl class="frm_0 mt-5 dsp_flex">
					<dt>
						<div class="_pc"><img src="/assets/images/replus/cmpfrm_ttl_4.png" /></div>
						<div class="_mobile">4. 물품 수거 요청 일자</div>
					</dt>
					<dd>
						<div class="frm_dd_box roundbox_5 class_shadow_rb">
							...
							<div class="mt-4 mb-3">
								...
								<div class="mt-2"><small style="font-size: .9rem;">※ 물품이 소규모이거나 수도권 외곽 지역일 경우 방문 희망일 보다 다소 늦어질 수 있습니다.</small></div>
				...
				*/ ?>
				...
				<input type="hidden" id="pickup_date_plz" class="o_input datepicker" name="pickup_date_plz" value="-" />
