<style type="text/css">
	...
	.info_erase dl dt:nth-child(1), .info_erase dl dd:nth-child(1) { width: 18%; }
	.info_erase dl dt:nth-child(2), .info_erase dl dd:nth-child(2) { width: 35%; }
	.info_erase dl dt:nth-child(3), .info_erase dl dd:nth-child(3) { width: 25%; }
	.info_erase dl dt:nth-child(4), .info_erase dl dd:nth-child(4) { width: 22%; }
</style>
