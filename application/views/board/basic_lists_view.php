...
<style type="text/css">
	/* 2022-12-18 */
	.bo_title strong { font-family:'Nanum Gothic','NanumGothic','나눔고딕','나눔 고딕', 'Noto Sans KR', AppleSDGothicNeo-Regular,'맑은 고딕','Malgun Gothic',dotum,'돋움',sans-serif;
					...
					<div class="bbs_white_list">
						...
						<table class="table table-hover table-md">
						  <colgroup class="dsp-none-mobile">
							...
							<col class="d-none d-md-table-cell" style="<?php echo (IS_MOBILE) ? 'width:120px;' : 'width:12%;' ?>">
							<col class="d-none d-md-table-cell" style="<?php echo (IS_MOBILE) ? 'width:90px;' : 'width:10%;' ?>">
							<!-- <col style="<?php echo (IS_MOBILE) ? '' : 'width:8%;' ?>"> -->
						  </colgroup>
						  <thead class="dsp-none-mobile">
							<tr>
							  ...
							  <th class="text-center d-none d-md-table-cell" scope="col" style="<?php echo (IS_MOBILE) ? 'width:120px;' : 'width:12%;' ?>">작성일</th>
							  <th class="text-center d-none d-md-table-cell" scope="col" style="<?php echo (IS_MOBILE) ? 'width:90px;' : 'width:10%;' ?>">조회</th>
							</tr>
						  </thead>
						  <tbody>
						  ...
						  <?php
							...
							<tr style="background-color:#fbfbfb;border-bottom:1px dashed #eeeeee;">
							  ...
							  <td class="text-center d-none d-md-table-cell" style="<?php echo (IS_MOBILE) ? 'width:120px;' : 'width:12%;' ?>"><?php echo substr($o->wr_datetime,0,10) ?></td>
							  <td class="text-center d-none d-md-table-cell" style="<?php echo (IS_MOBILE) ? 'width:90px;' : 'width:10%;' ?>"><?php echo $o->wr_hit ?></td>
							</tr>
							<?php
							} // foreach
							} // if
						  ...
						  ?>
							...
							<tr style="border-bottom:1px dashed #eeeeee;">
							  ...
							  <td class="text-center d-none d-md-table-cell"><?php echo $o->wr_name_input ?></td>
							  <td class="text-center d-none d-md-table-cell"><?php echo substr($o->wr_datetime,0,10) ?></td>
							  <td class="text-center d-none d-md-table-cell"><?php echo $o->wr_hit ?></td>
							</tr>
