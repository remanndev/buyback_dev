													...
													<div class="col-md-10" style="padding-bottom: 5px;">
														...
														?>
														  <div style="font-size: 12px;padding-top:5px ">
															<input type="file" name="attach_file_form[]" class="custom-file2-input" style="width:100%;" onchange="setThumbnail(event);" />
															<small style="display:block; padding-top: 10px; font-weight:normal; color:purple;<?php echo (IS_MOBILE) ? 'display:block;' : ''?>">(목록에 사용할 이미지를 업로드해주세요.)</small>
														  </div>
														<?php } ?>

														<figure id="image_container" style="margin:15px 0;"></figure>
														<script> 
