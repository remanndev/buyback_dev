...
// 나눔캠페인 시작일자
$input_date_begin = array(
	'name'	=> 'addfld_1',
	'id'	=> 'addfld_1',
	'value' => set_value('addfld_1',isset($row->addfld_1) ? $row->addfld_1 : ''),
	'maxlength'	=> 10,
	'class' => 'bo_input form-control datepicker  campaign_term',
	'style' => 'width: 120px; display: inline-block;',
	'autocomplete' => 'off',
	'placeholder' => '시작일자'
);
// 나눔캠페인 종료일자
$input_date_end = array(
	'name'	=> 'addfld_2',
	'id'	=> 'addfld_2',
	'value' => set_value('addfld_2',isset($row->addfld_2) ? $row->addfld_2 : ''),
	'maxlength'	=> 10,
	'class' => 'bo_input form-control datepicker  campaign_term',
	'style' => 'width: 120px; display: inline-block;',
	'autocomplete' => 'off',
			...
			<div style="margin:0 auto; ">
				...
				<div class="o_page_content">
					<section class="o_ctnt" >
						...
						<h3 class="bo_title"><strong><?php echo isset($bbs_cf->bo_title) ? $bbs_cf->bo_title : '게시판'; ?></strong></h3>
							...
							<br />
									...
									<?php echo form_open_multipart($this->uri->uri_string(), array('id'=>'board_form','name'=>'board_form','onsubmit'=>'frm_submit();')); ?>
										...
										<div>	
											...
											<div class="row">
												<div class="col-md-2 col-form-label d-none d-md-block py-0"><label class="frm-title">기간</label></div>
												<div class="col-md-10">
													<?php echo form_input($input_date_begin); ?> ~ 
													<?php echo form_input($input_date_end); ?>
													<?php echo form_error('addfld_2','<div class="err_color_red">','</div>'); ?>
												</div>
											</div>
											<div class="mb-2"></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.campaign_term').on('blur',function() {
			var term_begin = $('#addfld_1').val();
			var term_end = $('#addfld_2').val();
