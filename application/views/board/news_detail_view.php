...
<div class="pc_wrap">
  <div class="ctnt_wrap py_35">
	<div class="ctnt_inside">
		  ...
		  <div class="bbs_basic">
			...
			<section>
				...
				<div class="bbs_basic_detail ">
					...
					<div class="site-section newsncase_padding">
		...
		<!-- 이전글, 다음글 -->
		<style>
		  .bottom_list {border-top:2px solid #000000; padding:0;}
		  .bottom_list table {margin:0 auto; padding:0; width:100%;}
		  .bottom_list tr { border-bottom:1px solid #e5e5e5;}
		  .bottom_list th, .bottom_list td { line-height: 30px; padding: 10px; font-size:15px; border-right:1px dashed #e5e5e5; }
		  .bottom_list th { background-color:#f6f6f6; text-align: center; width: 10%; min-width:80px;}
		  .bottom_list td {width:100%;}
		  .bottom_list td.prevnext_date { width: 10%; min-width:110px; text-align:center; font-size:14px;}

		  .bottom_list tr.prevnext_current th, .bottom_list tr.prevnext_current td {background-color:#f8fcf5;}  /* #1496d4   //  #58ae31  #f8fcf5 */
		</style>
		<div class="contents_wrap">
			<div class="bottom_list mt-4">
				<table width="100%" cellpadding="0" cellspacing="0">
				  ...
				  <?php if( isset($row_prev->wr_idx) ) { ?>
				  <tr>
					<th>이전글</th>
					<td><a href="<?php echo $bbs_code_url ?>/detail/<?php echo $row_prev->wr_idx ?>"><?php echo $row_prev->wr_subject ?></a></td>
					<td class="prevnext_date d-none d-md-block"><?php echo str_replace('-','. ',substr($row_prev->wr_datetime,0,10)) ?></td>
				  </tr>
				  <?php } ?>
				  <tr class="prevnext_current">
					<th>▶</th>
					<td><?php echo $row->wr_subject ?></td>
					<td class="prevnext_date d-none d-md-block"><?php echo $row->wr_datetime_point ?></td>
				  </tr>
				  <?php if( isset($row_next->wr_idx) ) { ?>
				  <tr>
					<th>다음글</th>
					<td><a href="<?php echo $bbs_code_url ?>/detail/<?php echo $row_next->wr_idx ?>"><?php echo $row_next->wr_subject ?></a></td>
					<td class="prevnext_date d-none d-md-block"><?php echo str_replace('-','. ',substr($row_next->wr_datetime,0,10)) ?></td>
				  </tr>
				  <?php } ?>
				</table>
			</div>
...
<style>
	#bbs_newsncase_12 .bbs_rolling_pic { width: 100%; margin: 0 auto; }
	#bbs_newsncase_12 .bbs_rolling_pic figure { margin: 0 10px; }
</style>
<script type="text/javascript">
// 뉴스앤케이스 게시물
$('#bbs_newsncase_12 .bbs_rolling_pic').slick({
  dots: false,
  arrows: false,
  infinite: true,
  speed: 300,
