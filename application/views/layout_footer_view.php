	  ...
	  <div class="main_sect">
		<div class="main_ctnt">
			<div class="footer_logo">
				<img src="<?php echo IMG_DIR ?>/layout/replus_logo_black_202410.png" style="height: auto;" />
...
<div class="mobile_wrap d-block d-lg-none">
	<div class="footer_wrap">
		<div class="main_sect">
			<div class="footer_logo">
				<img class="flogo" src="<?php echo IMG_DIR ?>/layout/replus_logo_black_202410.png" />
			</div>
