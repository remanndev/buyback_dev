<div class=" admin_wrap">
	...
	<h1 style="position:relative;">
		랜딩 페이지 목록 
		<a href="/admin/contents/landing/form"><button type="button" class="btn btn-dark btn-ssm" style="position:absolute; bottom:9px; right:0;" onclick="location.href='/admin/contents/landing/form'">랜딩 페이지 등록하기</button></a>
	</h1>
		...
		<table class="table table-hover" style="width:100%;">
			...
			<tr style="<?php echo ($o->use_yn != 'Y') ? 'background-color:#f7f7f7;' : ''; ?>">
			  ...
			  <td class='text-center'>
				...
				<a href="javascript:post_send_del_again('admin/contents/landing/del', {idx:'<?php echo $o->idx;?>'}, true);"><button type="button" class="btn btn-danger btn-xs">삭제</button></a>
			  </td>
			</tr>
			<?php endforeach; ?>
			</tbody>
