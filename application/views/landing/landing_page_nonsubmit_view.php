...
<div class="ctnt_wrap py_35">
	<div class="">
		<div class="contents_wrap">
			<div class="redactor-styles redactor-in" style="width: 100%; max-width: 980px; padding-left: 15px; padding-right: 15px;">
				...
				<?php /*
				<!-- /files/download/<?php echo url_code('page/file','e') ?>/4c9dd3d0117fe1a3e7b4c67bcd0d5c6a.docx/<?php echo url_code('한국지능정보사회진흥원(NIA) X 리플러스 비영리단체 · 지역아동센터 PC 지원 사업 신청서.docx','e') ?> -->
				*/ ?> 
				...
				<?php echo form_open_multipart($this->uri->uri_string(), array('id'=>'form','name'=>'form', 'onsubmit'=>'return frmchk();')); ?>
					...
					<div class="rsp_frm">
					  ...
					  <?php } else { ?>
						...
						<div class="d-none"><input id="agree" type="checkbox" name="agree" value="agree" checked /></div>
					  ...
					  ?>
						<div class="fld_wrap">
						  <dl>
							<dt>
								파일 첨부 <?php echo $no ?>
								<div class="" style="line-height: 100%; font-size: 14px; font-weight: normal;">(<?php echo $arr_file_ttl[$i] ?>)</div>
							</dt>
							<dd>
							  <p>
								...
								<div><input type="file" name="attach_file[]" class="o_input" style="width:100%; padding:0; border:none;" /></div>
