...
class Sendmail_test extends CI_Controller {
	...
	public function index() {
		...
		/*
			/config/email.php 설정에 구글 SMTP 세팅 되어 있음.
		...
		*/
		...
		//$from_email = 'ipmiracle1@gmail.com';
