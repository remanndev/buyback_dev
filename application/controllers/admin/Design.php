...
class Design extends CI_Controller
{
	function __construct()
	{
		...
		*/
		...
		$arr = array('sql_select' => 'bn_category,bn_code,bn_name','sql_from' => 'mng_banner','sql_where' => array('bn_id >' => 0),'sql_order_by' => 'bn_category ASC, bn_name ASC','sql_group_by'=>'bn_code');
